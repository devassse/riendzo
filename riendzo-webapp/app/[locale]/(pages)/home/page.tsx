...
const ACTIVITIES: Activity[] = [
    {
        ...
        tag: 'Vida marinha',
        image: '/home/things-to-do/tofo.jpg',
        icon: <IconWhaleShark />,
        href: '/lugares/tofo',
    },
    {
        ...
        tag: 'Mergulho',
        image: '/home/things-to-do/bazaruto.jpg',
        icon: <IconReef />,
        href: '/lugares/bazaruto',
    },
    {
        ...
        tag: 'Safári',
        image: '/home/things-to-do/gorongosa.jpg',
        icon: <IconPawprint />,
        href: '/lugares/gorongosa',
    },
    {
        ...
        tag: 'Património',
        image: '/home/things-to-do/ilha-mocambique.jpg',
        icon: <IconLandmark />,
        href: '/lugares/ilha-de-mocambique',
    },
    {
        ...
        tag: 'Ilhas',
        image: '/home/things-to-do/quirimbas.jpg',
        icon: <IconSail />,
        href: '/lugares/quirimbas',
    },
    {
        ...
        tag: 'Cidade',
        image: '/home/things-to-do/maputo.jpg',
        icon: <IconCity />,
        href: '/lugares/maputo',
    },
];
...
export default function ThingsToDoSection() {
    return (
        <section className="bg-[#f7f5f0] px-6 py-20 sm:px-10">
            <div className="mx-auto max-w-6xl">
                <div className="max-w-xl">
                    <span className="font-body text-xs font-semibold uppercase tracking-[0.16em] text-[#1f7a5c]">
                        Explorar Moçambique
                    </span>
                    <h2 className="mt-3 font-body text-4xl font-bold leading-tight text-[#1c231f] sm:text-5xl">
                        6 experiências imperdíveis
                    </h2>
                    <p className="mt-4 font-body text-base leading-relaxed text-[#5c6660]">
                    ...
                    {ACTIVITIES.map((activity) => (
                        ...
                        >
                            <div className="relative aspect-[4/3] w-full overflow-hidden">
                                ...
                                />
                                <span className="absolute left-3 top-3 flex h-9 w-9 items-center justify-center rounded-full bg-white/90 text-[#1f7a5c] backdrop-blur-sm">
                            ...
                            <div className="p-5">
                                ...
                                <h3 className="mt-2 font-body text-lg font-bold leading-snug text-[#1c231f] group-hover:text-[#1f7a5c]">
                                    {activity.title}
                                </h3>
                                <p className="mt-2 font-body text-sm leading-relaxed text-[#5c6660]">
